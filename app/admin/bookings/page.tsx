...
export default function BookingsPage() {
  ...
  const filteredBookings = bookings.filter(booking => {
    ...
    const matchesPayment = filters.paymentStatus === 'all' || booking.payment_status === filters.paymentStatus;
    const matchesSearch = booking.customer_name.toLowerCase().includes(filters.search.toLowerCase()) ||
                         booking.service.toLowerCase().includes(filters.search.toLowerCase()) ||
                         (booking.customer_email && booking.customer_email.toLowerCase().includes(filters.search.toLowerCase()));
  ...
  const BookingCard = ({ booking }: { booking: Booking }) => (
    ...
    >
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
        <span className={`px-2 py-1 text-xs font-medium rounded-full border ${getPaymentStatusColor(booking.payment_status)}`}>
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and track all your customer bookings.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">£{bookings.reduce((sum, b) => sum + b.amount, 0)}</p>
            </div>
          </div>
        </div>
      </div>
                ...
                {filteredBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900 max-w-xs truncate">{booking.service}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          {filteredBookings.length === 0 && !loading && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {bookings.length === 0 ? 'Get started by creating your first booking.' : 'Try adjusting your search or filter criteria.'}
              </p>
              {bookings.length === 0 && (
                <button
                  onClick={() => setShowNewBookingModal(true)}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">
                      {format(parseISO(selectedBooking.date), 'EEEE, MMMM d, yyyy')} at {selectedBooking.time}
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <div>
                      ...
                      <span className={`inline-block px-2 py-1 text-xs font-medium rounded-full border ${getPaymentStatusColor(selectedBooking.payment_status)}`}>
      ...
      {showNewBookingModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onClick={() => setShowNewBookingModal(false)}></div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Call-out & Hourly Labour Rates">Call-out & Hourly Labour Rates</option>
                        <option value="Full-Day Booking Rates">Full-Day Booking Rates</option>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewBooking(prev => ({ ...prev, amount: e.target.value }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
