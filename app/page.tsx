...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <div className="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-blue-900/50 rounded-full text-blue-800 dark:text-blue-300 text-sm font-medium mb-6">
                  ...
                  About <AdminProfileData type="name" fallback="Plamen Zhelev" />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-800">
                      <div className="w-8 h-8 bg-green-500 dark:bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                        <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
                        </svg>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-green-800 dark:text-green-200">Experience</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                      ...
                      <div>
                        <p className="text-sm font-medium text-blue-800 dark:text-blue-200">Certifications</p>
                        <p className="text-sm text-blue-700 dark:text-blue-300">
                          <AdminProfileData type="certifications" fallback="Gas Safe Registered" />
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-800">
                      ...
                      <div>
                        <p className="text-sm font-medium text-purple-800 dark:text-purple-200">Response Time</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800">
                      ...
                      <div>
                        <p className="text-sm font-medium text-amber-800 dark:text-amber-200">Specializations</p>
                        <p className="text-sm text-amber-700 dark:text-amber-300">
                          <AdminProfileData type="specializations" fallback="Emergency repairs, Boiler installations" />
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 transition-colors duration-300">{service}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              {/* Floating Stats */}
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 transition-colors duration-300">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white transition-colors duration-300">500+</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Jobs Completed</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-500" id="areas">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              Professional plumbing services across South West London with rapid response times
            </p>
          </div>

          {areasLoading ? (
            <div className="text-center py-8">
              <div className="text-gray-600 dark:text-gray-300">Loading service areas...</div>
            </div>
          ) : (
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-6 text-center transition-all duration-300">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300 font-medium transition-colors duration-300">
              We aim to arrive within <AdminProfileData type="response_time" fallback="45 minutes" /> for emergency callouts in our
              main service areas.
            </p>
          </div>
        </div>
      ...
      {/* Contact Section */}
      <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-500" id="contact">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-300">
                  Contact us today for fast, reliable plumbing services. We're available 24/7 for emergencies.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 transition-colors duration-300">Call us anytime, 24/7 emergency service</p>
                    <a href="tel:+447700900123" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold transition-colors duration-300">
                      <AdminProfileData type="phone" fallback="+44 7700 900123" />
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 transition-colors duration-300">Send us your questions anytime</p>
                    <a href="mailto:plamen@fixmyleak.co.uk" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold transition-colors duration-300">
                      <AdminProfileData type="email" fallback="plamen@fixmyleak.co.uk" />
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white transition-colors duration-300">Service Area</h3>
                    <p className="text-gray-600 dark:text-gray-400 transition-colors duration-300">South West London coverage</p>
                    <p className="text-blue-600 dark:text-blue-400 font-semibold">
                      <AdminProfileData type="service_areas" fallback="Clapham, Balham, Chelsea, Wandsworth, Battersea" />
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Credentials */}
              <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 transition-colors duration-300">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Professional Credentials</h3>
                <div className="flex flex-wrap gap-2 pt-4">
                  ...
                  <div className="flex items-center bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full border border-white/20">
                    ...
                    <span className="text-white/90 text-xs font-medium">
                      Gas Safe: <AdminProfileData type="gas_safe_number" fallback="GAS123456" />
                    </span>
                  </div>
                </div>
              </div>
            ...
            {/* Booking Form */}
            <div className="bg-gray-50 dark:bg-gray-800 rounded-3xl p-8 transition-colors duration-300">
              <FormBooking />
            </div>
          </div>
        </div>
