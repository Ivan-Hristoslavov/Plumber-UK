...
export function FormBooking() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!data.name || !data.email || !data.phone || !data.address || !data.service || !data.preferredDate || !data.timeSlot) {
      ...
      const existingCustomer = existingCustomers.find((c: any) => c.email === data.email);
      ...
      const bookingData = {
        ...
        amount: data.isEmergency ? 120.00 : 80.00, // Default amounts
        address: data.address,
      ...
      setSubmitMessage('Your booking request has been sent successfully! We have received your details and will contact you within 45 minutes to confirm your appointment.');
    ...
    <form key={formKey} onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="group md:col-span-2">
          <label htmlFor="address" className="block text-xs font-semibold text-white mb-1">
            Service Address *
          </label>
          <div className="relative">
            <textarea
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/70 mb-1">{service.description}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="group">
          <label htmlFor="preferred-date" className="block text-xs font-semibold text-white mb-1">
            Preferred Date *
          </label>
          <div className="relative">
            <input
        ...
        <div className="group">
          <label htmlFor="timeSlot" className="block text-xs font-semibold text-white mb-1">
            Preferred Time *
          </label>
          <div className="relative">
            <select
      ...
      {/* Problem Description */}
      <div className="group">
        <label htmlFor="description" className="block text-xs font-semibold text-white mb-1">
          Problem Description
        </label>
        <div className="relative">
          <textarea
      ...
      <div className="bg-red-500/20 border border-red-400/30 rounded-lg p-3">
        <div className="flex items-center">
          ...
          />
          <label htmlFor="isEmergency" className="ml-2 flex items-center">
            ...
            <div className="text-center">
              ...
              <div className="bg-green-600/30 rounded-lg p-3 border border-green-400/30">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-xs font-semibold text-green-200">Next Steps</span>
                </div>
                <ul className="text-xs text-green-300 space-y-1">
                  ...
                  <li>✓ Emergency? Call us directly: <strong>07541777225</strong></li>
                </ul>
              </div>
            </div>
          ) : (
