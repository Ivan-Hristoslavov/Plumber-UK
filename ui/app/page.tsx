...
export default function HomePage() {
  return (
    <div className="space-y-20">
                ...
                <div className="mt-6 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 px-6 py-4 transform group-hover:scale-105 transition-all duration-300">
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-3">
                      ...
                      <span className="text-sm text-gray-600 font-medium">JIB Gold Card • 10+ Years</span>
                    </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-500">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    With over 10 years of hands-on experience and a JIB Gold Card, I run my own company – PZ Plumbing Ltd.
                  </p>
      ...
      {/* Contact Section */}
      <section id="contact" className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-blue-800 py-20 overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              {/* Contact Cards */}
              <div className="space-y-6">
                <div className="group bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-yellow-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                      <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <div>
                      <p className="font-semibold text-white text-lg">Emergency Hotline</p>
                      <p className="text-white/80 text-xl font-bold">07541777225</p>
                      <p className="text-white/60 text-sm mt-1">45 min response time guaranteed</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-xl font-bold">yo_plam@yahoo.com</p>
                      <p className="text-white/60 text-sm mt-1">Free consultation available</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-white text-lg">Service Areas</p>
                      <div className="text-white/80 space-y-1">
                        <p className="font-bold">London Coverage</p>
                        <p>Clapham • Balham • Chelsea</p>
                        <p>Wandsworth • Battersea</p>
                        <p className="text-sm text-white/60 mt-2">Same-day service guaranteed</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-wrap gap-4 pt-8">
                <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  ...
                  <span className="text-white/90 text-sm font-medium">JIB Gold Card</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  <svg className="w-5 h-5 mr-2 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clipRule="evenodd" />
                  </svg>
                  <span className="text-white/90 text-sm font-medium">Public Liability Insurance</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  <svg className="w-5 h-5 mr-2 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-white/90 text-sm font-medium">PZ Plumbing Ltd</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20">
              <h3 className="text-2xl font-semibold text-white mb-6">Book a Service</h3>
              <FormBooking />
            </div>
          </div>
        </div>
