...
export function ReviewsSection() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-white dark:bg-gray-900" id="reviews">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900 dark:text-white">What Our Clients Say</h2>
        ...
        {reviews.length === 0 ? (
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">No Reviews Yet</h3>
