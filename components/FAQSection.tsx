...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'For emergency calls, we aim to respond within 30-60 minutes in major cities and within 2 hours in rural areas.',
  },
  {
    question: 'Do you provide warranties on your work?',
    answer: 'Yes, we provide comprehensive warranties on all our work. Parts come with manufacturer warranties, and our workmanship is guaranteed for 12 months.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqItems.map((item, index) => (
            <div 
              key={index} 
              className="group bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden"
            >
              <button
              ...
              >
                ...
                <div className={`flex-shrink-0 w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center transition-transform duration-300 ${
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-8 text-white">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Our friendly team is here to help. Get in touch and we'll answer any questions you have about our services.
            </p>
            <a
              href="#contact"
              onClick={(e) => {
