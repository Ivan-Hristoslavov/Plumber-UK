...
export default function LayoutMain({
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <NavigationNavbar />
      <main className={`flex-grow transition-all duration-300 ${hasDayOffBanner ? 'pt-[112px]' : 'pt-20'}`}>
        {children}
      </main>
      <ButtonCallNow />
      ...
      <footer className="relative bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Professional plumbing services across London. Available 24/7 for emergency repairs. 
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 FixMyLeak. All rights reserved. Licensed & Insured Plumbers.
            </p>
        ...
        {/* Decorative Elements */}
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600"></div>
      </footer>
    </div>
  );
} 