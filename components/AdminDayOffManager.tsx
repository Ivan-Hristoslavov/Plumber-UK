...
export function AdminDayOffManager() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-3 sm:space-y-4">
      ...
      {/* Add/Edit Modal */}
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 animate-fade-in p-0 sm:p-4 md:p-6 lg:p-8 overflow-y-auto">
          <div className="w-full sm:max-w-3xl xl:max-w-4xl bg-white dark:bg-gray-800 rounded-t-2xl sm:rounded-2xl shadow-2xl transform transition-all animate-fade-in-up overflow-hidden max-h-[95vh] sm:max-h-[90vh] lg:max-h-none lg:overflow-visible flex flex-col sm:mt-0">
            {/* Header - compact on mobile */}
            <div className="bg-white dark:bg-gray-800 px-4 sm:px-6 py-2.5 sm:py-3 text-gray-900 dark:text-white sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700 shrink-0">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-md bg-blue-600/10 flex items-center justify-center shrink-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-sm sm:text-lg font-semibold truncate">
                      {editingId ? 'Edit Day Off' : 'Add Day Off'}
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 text-[11px] sm:text-xs truncate hidden sm:block">
                      {editingId ? 'Update period settings' : 'Create a new period'}
                    </p>
                  </div>
                </div>
                <button 
            ...
            {/* Content - compact on mobile, scrollable */}
            <div className="p-3 sm:p-5 space-y-3 sm:space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-4 overflow-y-auto flex-1 min-h-0">
              {/* Left column: Basic Information */}
              <div className="space-y-2 sm:space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  <div>
                    <label htmlFor="dayoff-title" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-0.5 sm:mb-1">
                      Title <span className="text-red-500">*</span>
                    </label>
                    <input
                      id="dayoff-title"
                      type="text"
                      className="w-full px-2.5 sm:px-3 py-1.5 sm:py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-sm"
                  ...
                  <div>
                    <label htmlFor="dayoff-description" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-0.5 sm:mb-1">
                      Description
                    </label>
                    <input
                ...
                <div className="flex gap-3">
                  <div className="flex flex-col">
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-0.5 sm:mb-1">
                      Start <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="date"
                      className="w-auto min-w-[90px] sm:min-w-[110px] px-1.5 sm:px-2 py-1.5 sm:py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-xs sm:text-sm"
                ...
                {/* Info message - compact on mobile */}
                {!editingId && (
                  <div className="p-2 sm:p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <div className="flex items-start gap-1.5 sm:gap-2">
                      <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <p className="text-[11px] sm:text-xs text-blue-700 dark:text-blue-300 leading-snug">
                        Day-off starting today disables today in the booking calendar.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2 sm:p-3 space-y-2 sm:space-y-3">
                <h4 className="text-xs font-semibold text-gray-900 dark:text-white">
                  Settings
                </h4>
                
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-between p-1.5 sm:p-2 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500">
                    <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                      <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                        <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5z" />
                        </svg>
                      </div>
                      <div className="min-w-0">
                        <label className="text-xs font-medium text-gray-900 dark:text-white">Show Banner</label>
                        <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">Display on website</p>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-1.5 sm:p-2 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500">
                    <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                      <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center shrink-0">
                        <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                      </div>
                      <div className="min-w-0">
                        <label className="text-xs font-medium text-gray-900 dark:text-white">Recurring</label>
                        <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">Repeat automatically</p>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  {form.show_banner && (
                  <div className="p-1.5 sm:p-2 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500">
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-0.5 sm:mb-1">
                      Banner Message
                    </label>
                    <textarea
                      className="w-full px-2 py-1 border border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded text-xs min-h-[52px]"
                  ...
                  {form.is_recurring && (
                    <div className="p-1.5 sm:p-2 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500">
                      ...
                      <select
                        className="w-full px-2 py-1.5 sm:py-1 border border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded text-xs"
              ...
              {/* Preview - fits screen, with gap */}
              <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2 sm:p-3 shrink-0 overflow-hidden mt-1">
                <h4 className="text-xs font-semibold text-gray-900 dark:text-white mb-1.5 sm:mb-2">
                  Preview
                </h4>
              ...
              <div className="lg:col-span-2 flex justify-end gap-2 sm:gap-3 pt-2 sm:pt-3 border-t border-gray-200 dark:border-gray-700 shrink-0">
                <button
                ...
                <button
                  className="px-4 sm:px-5 py-1.5 sm:py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 text-sm min-w-[100px] sm:min-w-[140px]"
                  onClick={handleSave}
                  disabled={saving}
                >
                  {saving ? (
