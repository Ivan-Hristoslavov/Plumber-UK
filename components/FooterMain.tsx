      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className={`grid grid-cols-1 ${serviceAreas.length > 0 ? 'md:grid-cols-4' : 'md:grid-cols-3'} gap-8`} suppressHydrationWarning>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            {/* Social Media Links */}
            {((SHOW_FACEBOOK && process.env.NEXT_PUBLIC_SOCIAL_MEDIA_FACEBOOK) || (SHOW_INSTAGRAM && process.env.NEXT_PUBLIC_SOCIAL_MEDIA_INSTAGRAM)) && (
              <div className="mt-6 flex space-x-4">
                {SHOW_FACEBOOK && process.env.NEXT_PUBLIC_SOCIAL_MEDIA_FACEBOOK && (
                  <a
                ...
                {SHOW_INSTAGRAM && process.env.NEXT_PUBLIC_SOCIAL_MEDIA_INSTAGRAM && (
                  <a
