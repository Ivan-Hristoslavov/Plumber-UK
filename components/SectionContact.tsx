    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <div className="inline-flex items-center px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/50 dark:to-indigo-900/50 rounded-full text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-semibold mb-4 sm:mb-6 shadow-sm">
            <svg
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-6 transition-colors duration-300">
            Contact & Book Your Service
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-300 max-w-4xl mx-auto">
        ...
        <div className="space-y-8 sm:space-y-12">
          {/* Row 1: Contact Information Cards — horizontal rows on mobile, grid on desktop */}
          {/* Mobile layout */}
          <div className="flex flex-col gap-3 sm:hidden">
            {/* Emergency */}
            <a
              href={`tel:${businessData.businessPhone}`}
              className="flex items-center gap-3 bg-white dark:bg-gray-800 rounded-xl p-3 shadow-md border border-gray-200 dark:border-gray-700 active:scale-[0.98] transition-transform"
            >
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline justify-between gap-2">
                  <span className="font-bold text-sm text-gray-900 dark:text-white">Regular Service</span>
                  <span className="text-[11px] text-gray-500 dark:text-gray-400 shrink-0">From £{businessData.standardRate}/hr</span>
                </div>
                <span className="text-green-600 dark:text-green-400 font-semibold text-sm">{businessData.businessPhone}</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline justify-between gap-2">
                  <span className="font-bold text-sm text-gray-900 dark:text-white">Email Us</span>
                  <span className="text-[11px] text-gray-500 dark:text-gray-400 shrink-0">{businessData.responseTime} response</span>
                </div>
                <span className="text-blue-600 dark:text-blue-400 font-semibold text-sm truncate block">{businessData.businessEmail}</span>
              </div>
            </a>

            {/* Coverage */}
            {serviceAreas.length > 0 && (
              <div className="flex items-start gap-3 bg-white dark:bg-gray-800 rounded-xl p-3 shadow-md border border-gray-200 dark:border-gray-700">
                ...
                <div className="min-w-0 flex-1">
                  <span className="font-bold text-sm text-gray-900 dark:text-white">Coverage Areas</span>
                  <div className="flex flex-wrap gap-1 mt-1.5">
                    {serviceAreas.map((area) => (
                      <span key={area.id} className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300">
                        {area.name}
                      </span>
                    ))}
                  </div>
          ...
          <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-600">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">{isLoadingSettings ? "Loading..." : formatWorkingHours()}</p>
                {isLoadingSettings ? (
                  <div className="animate-pulse space-y-2">
                    <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-32"></div>
                    <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-24"></div>
                  ...
                  <>
                    ...
                    <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">From £{businessData.standardRate}/hour</div>
                  </>
                )}
              </div>
            </div>
              ...
              <div className="relative">
                ...
                {isLoadingSettings ? (
                  ...
                  <>
                    ...
                    <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">Response within {businessData.responseTime}</div>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600">
              ...
              <div className="relative">
                ...
                {isLoadingAreas ? (
                  ...
                  <div className="text-purple-600 dark:text-purple-400 font-semibold text-sm">Clapham, Balham, Chelsea</div>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-4 sm:px-6 md:px-8 py-4 sm:py-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                ...
                <div className="hidden lg:flex items-center space-x-6 text-white shrink-0">
