...
export function SectionHero() {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-12 h-12 bg-white/5 rounded-full animate-bounce z-10" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-40 left-20 w-20 h-20 bg-white/5 rounded-full animate-pulse z-10" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 text-white leading-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          Professional
        ...
        <p className="text-xl sm:text-2xl mb-10 max-w-3xl mx-auto text-white/90 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          Expert plumbers available across the United Kingdom. 
          <span className="block mt-2 font-semibold text-blue-300">Fast response • Quality guaranteed • Fair pricing</span>
        </p>
        ...
        {/* Trust Indicators */}
        <div className="mt-12 flex flex-wrap justify-center items-center gap-8 text-white/70 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
